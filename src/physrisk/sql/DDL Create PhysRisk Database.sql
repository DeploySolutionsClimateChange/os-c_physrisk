...
CREATE TABLE osc_physrisk_risk_analysis.fact_portfolio_impact ( 
	...
	CONSTRAINT fk_fact_portfolio_analysis_scenario_type_id FOREIGN KEY ( scenario_type_id ) REFERENCES osc_physrisk_scenario.scenario_type(scenario_type_id),
...
INSERT INTO osc_physrisk.osc_physrisk_scenario.scenario_type
...
SELECT * FROM osc_physrisk.osc_physrisk_scenario.scenario_type WHERE culture='en';
SELECT * FROM osc_physrisk.osc_physrisk_scenario.scenario_type WHERE culture='fr';
SELECT * FROM osc_physrisk.osc_physrisk_scenario.scenario_type WHERE culture='es';

SELECT a."name" as "English Name",  b.culture as "Translated Culture",  b."name" as "Translated Name", b.description_full as "Translated Description", b.tags as "Translated Tags" FROM osc_physrisk.osc_physrisk_scenario.scenario_type a 
...
--UPDATE osc_physrisk.osc_physrisk_scenario.scenario_type
