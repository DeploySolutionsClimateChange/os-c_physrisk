...
CREATE TABLE osc_physrisk_hazards.hazard_indicator ( 
	...
	CONSTRAINT fk_hazard_indicator_hazard_id FOREIGN KEY ( hazard_id ) REFERENCES osc_physrisk_hazards.hazard(hazard_id)
 );
...
CREATE TABLE osc_physrisk_financial_models.financial_model ( 
	financial_model_id	UUID  DEFAULT gen_random_uuid () NOT NULL,
	name        varchar(256)  NOT NULL  ,
	name_fullyqualified varchar(256)    ,
	description_full   text NOT NULL,
	description_short  varchar(256)  NOT NULL  ,
	...
	publisher_id        bigint    ,
	published_date      timestamptz    ,
	CONSTRAINT pk_financial_model PRIMARY KEY ( financial_model_id )
 );
...
CREATE TABLE osc_physrisk_analysis_results.fact_portfolio_impact ( 
	...
	CONSTRAINT fk_fact_portfolio_analysis_scenario_id FOREIGN KEY ( analysis_scenario_id ) REFERENCES osc_physrisk_scenarios.scenario(scenario_id),
	CONSTRAINT fk_fact_portfolio_analysis_impact_type_id FOREIGN KEY ( impact_type_id ) REFERENCES osc_physrisk_analysis_results.impact_type(impact_type_id),
	CONSTRAINT fk_fact_portfolio_analysis_hazard_id FOREIGN KEY ( analysis_hazard_id ) REFERENCES osc_physrisk_hazards.hazard(hazard_id)     
 );
...
CREATE TABLE osc_physrisk_analysis_results.fact_asset_impact ( 
	...
	CONSTRAINT fk_fact_asset_analysis_scenario_id FOREIGN KEY ( analysis_scenario_id ) REFERENCES osc_physrisk_scenarios.scenario(scenario_id),
