...
CREATE TABLE osc_physrisk_analysis_results.asset_impact ( 
	...
	CONSTRAINT fk_asset_analysis_scenario_id FOREIGN KEY ( scenario_id ) REFERENCES osc_physrisk_scenarios.scenario(id),
	...
	CONSTRAINT fk_asset_analysis_hazard_id FOREIGN KEY ( hazard_id ) REFERENCES osc_physrisk_hazards.hazard(id)    ,
